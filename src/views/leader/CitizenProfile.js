...
export default function CitizenProfile() {
  ...
  const handleSubmit = (event) =>{
    ...
    fetch(`http://localhost:5000/citizen/update_profile/${citizenId}`, {
      ...
      date: inputText.card_id.date,
      expiration: inputText.card_id.expiration,
  ...
  return (
    <>
      {showModal ? (<><div className="flex-auto px-4 lg:px-10 py-10 pt-0">
    <form>
              ...
              <div className="w-full lg:w-4/12 px-4">
                <div className="relative w-full mb-3">
                  ...
                  <input
                    type="date"
                    className="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                    name="card_id.expiration"
                    value={inputText.card_id.expiration}
                    onChange={handleChange}
                  />
                </div>
              </div>
